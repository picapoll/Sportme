...
geoXML3.parser = function (options) {
  ...
  if (!parserOptions.infoWindow && parserOptions.singleInfoWindow && !!window.google && !!google.maps) { parserOptions.infoWindow = new google.maps.InfoWindow() }
        ...
        // What sort of placemark?
              switch (Geometry) {
                case 'Point':
                  ...
                  if (!!window.google && !!google.maps) { placemark.latlng = new google.maps.LatLng(placemark.Point.coordinates[0].lat, placemark.Point.coordinates[0].lng) }
                  pathLength = 1
                  break
                case 'LinearRing':
            // Polygon/line
...
geoXML3.isParseError = function (parsedDocument) {
  if ((typeof ActiveXObject !== 'undefined') || ('ActiveXObject' in window)) { return false }
